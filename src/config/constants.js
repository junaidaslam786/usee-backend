...
export const EMAIL_SUBJECT = {
  ...
  AGENT_REGISTRATION_AWAITING_APPROVAL: 'New Trader Registration Awaiting Approval',
...
export const EMAIL_TEMPLATE_PATH = {
  ...
  AGENT_REGISTRATION_AWAITING_APPROVAL: 'email-template/agent-registration-awaiting-approval.ejs',
