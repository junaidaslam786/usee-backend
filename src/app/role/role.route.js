...
router.post('/create', isAuthenticated,
  verifyPermissions(['role']), validate(roleValidations.createRoleRules), roleController.createRole);
router.put('/update', isAuthenticated,
  verifyPermissions(['role']), validate(roleValidations.updateRoleRules), roleController.updateRole);
